class Admin::ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:title, :sku, :part_number, :description, :status, :product_image, :price, :on_hand, :category_id, :discount)
    end

    def set_category_tree
      @categories_tree = Category.categories_tree_list
    end
end
